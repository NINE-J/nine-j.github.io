document.addEventListener("DOMContentLoaded", () => {
  ...
  function createModal(svg) {
    ...
    Object.assign(modalContent.style, {
      background: isDark ? '#222' : '#fff', padding: '24px', borderRadius: '12px',
      boxShadow: '0 2px 16px rgba(0,0,0,0.2)', position: 'relative', maxWidth: '90vw', maxHeight: '80vh', overflow: 'auto'
    });
    // 버튼 그룹 래퍼 생성
  ...
  function createButtonGroup(parent, svg, wrapper, zoom) {
    ...
    if (!btnWrapper) {
      ...
      btnWrapper.className = 'mermaid-btn-wrapper';
      Object.assign(btnWrapper.style, {
        position: 'absolute', top: '12px', right: '12px', display: 'flex', gap: '8px', zIndex: '5'
      });
