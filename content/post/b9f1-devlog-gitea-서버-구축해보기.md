...
* ID: giteaadmin, PW: giteaadmin, e-mail: [jgjo@kors.co.kr](mailto:jgjo@kors.co.kr)
...
* gitea 문서: [https://docs.gitea.com/next/administration/https-setup](https://docs.gitea.com/next/administration/https-setup)
...
1. **다운로드**: OpenSSL 공식 웹사이트에서 Windows용 설치 파일을 다운로드한다. [https://slproweb.com/products/Win32OpenSSL.html](https://slproweb.com/products/Win32OpenSSL.html)
...
* Gitea Forum: [https://forum.gitea.com/](https://forum.gitea.com/)
